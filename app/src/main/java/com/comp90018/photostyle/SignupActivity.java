...
public class SignupActivity extends AppCompatActivity {
    ...
    @BindView(R2.id.input_address) EditText _addressText;
    @BindView(R2.id.input_email) EditText _emailText;
    @BindView(R2.id.input_mobile) EditText _mobileText;
    @BindView(R2.id.input_password) EditText _passwordText;
    @BindView(R2.id.input_reEnterPassword) EditText _reEnterPasswordText;
